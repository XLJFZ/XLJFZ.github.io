    ...
    <main id="top">
      ...
      >
        <div>
          ...
          <h1 className="mt-4 text-[clamp(2.8rem,6.5vw,5.8rem)] font-medium leading-[.94] tracking-[-.055em]">
            关于
            <br />
            迅雷疾风
          </h1>
        ...
        <div className="max-w-xl md:pt-16">
          <p className="text-xl font-light leading-9 tracking-[-.02em]">
            我是一名关注城市建筑与自然地景的摄影师。镜头不是答案，而是持续观看世界的方式。现就读于西安交通大学，持续在学习与行走之间记录光线、空间与时间。
          </p>
          <div className="mt-12 space-y-5 text-sm font-light leading-7 text-foreground/60">
            <p>
              作品常从日常行走开始：城市中被忽略的转角、光落在材料上的几秒钟，以及天气将熟悉景观变得陌生的时刻。
            </p>
            <p>
              目前工作与生活于上海，可接受建筑、风光、旅行及编辑类拍摄委托。
            </p>
          </div>
          <div className="mt-14 border-t border-foreground/10 pt-6">
            <p className="text-[10px] uppercase tracking-[.2em] text-foreground/40">
              联系与社交
            </p>
            <div className="mt-4 flex flex-wrap items-center gap-x-7 gap-y-3 text-sm">
              <CopyEmailButton className="text-sm font-normal">
                zbzzzzzzz@qq.com
              </CopyEmailButton>
              <a
