...
function buildGalleryRows(images: PortfolioImage[]) {
  const pending: GalleryItem[] = images.map((image, sourceIndex) => ({
    image,
    sourceIndex,
  }));
    ...
    <>
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="group block w-full overflow-hidden bg-[#292824] shadow-[0_18px_55px_rgba(0,0,0,.26)]"
                  ...
                  {image.caption && (
                    <figcaption className="pt-3 text-[10px] tracking-[0.16em] text-foreground/45 md:pt-4">
                      {image.caption}
                    </figcaption>
                  )}
                </figure>
      ...
      >
        <DialogContent
          ...
          className="h-[100svh] max-h-none w-screen max-w-none border-0 bg-black p-0 text-white ring-0"
        >
          ...
          {active !== null && displayedItems[active].image.caption && (
            <p className="absolute bottom-4 left-4 text-[10px] tracking-[0.16em] text-white/65 md:left-7">
          ...
          {active !== null && (
            <p
              aria-live="polite"
              className="absolute bottom-4 left-1/2 -translate-x-1/2 text-[10px] tracking-[0.2em] text-white/65"
            >
