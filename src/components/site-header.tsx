export function SiteHeader({ inverse = false }: { inverse?: boolean }) {
  return (
    <header className={`flex items-center justify-between px-5 py-5 md:px-10 md:py-7 ${inverse ? 'absolute inset-x-0 top-0 z-20 text-white mix-blend-difference' : 'border-b border-foreground/10'}`}>
