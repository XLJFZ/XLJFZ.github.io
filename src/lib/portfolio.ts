...
export const series: Series[] = [
  {
    ...
    images: [
      ...
      { src: '/portfolio/urban-pulse/shanghai-zbz-8285.jpg', alt: '粉紫朝霞下的上海城市天际线与里弄', caption: '上海 · 2026', layout: 'portrait' },
      { src: '/portfolio/urban-pulse/shanghai-zbz-7973.jpg', alt: '洛克·外滩源街区建筑与斜射光影', caption: '上海 · 2026', layout: 'portrait' },
      { src: '/portfolio/urban-pulse/shanghai-zbz-8705.jpg', alt: '橙色晚霞笼罩上海城市天际线', caption: '上海 · 2026' },
      ...
      { src: '/portfolio/urban-pulse/guangzhou-zbz-6789.jpg', alt: '广州石室圣心大教堂与街道人群', caption: '广州 · 2025', layout: 'portrait' },
      { src: '/portfolio/urban-pulse/guangzhou-rpx-00040.jpg', alt: '草坡上的行人与广州珠江新城高楼', caption: '广州 · 2025', layout: 'portrait' },
      { src: '/portfolio/urban-pulse/shenzhen-zbz-7358.jpg', alt: '长曝光云层下的深圳城市天际线', caption: '深圳 · 2025', layout: 'portrait' },
  ...
  },
  {
    ...
    images: [
      ...
      { src: '/portfolio/zbz-1242-meili.jpg', alt: '星轨下的梅里雪山雪峰', caption: '德钦 · 2025', layout: 'medium' },
  ...
  },
  {
    ...
    statement: '石窟、木构、室内与民艺在时间中留下各自的表面。光线落在雕刻、斗拱、织物与日常器物上，让历史不再遥远。',
